            ...
            <Card className="bg-white">
                ...
                {!voiceActive ? (
                    ...
                    <div className="w-24 h-24 mx-auto bg-blue-100 rounded-full flex items-center justify-center">
                        <Mic className="w-12 h-12" style={{ color: '#3b82f6' }} />
                    </div>
    ...
    <div className="space-y-6">
      <div className="text-center pb-6 border-b">
        <div className="relative w-24 h-24 mx-auto mb-4">
          ...
          <Volume2 className="w-12 h-12" style={{ color: '#3b82f6' }} />
          </div>
        </div>
                ...
                <ul className="space-y-2">
                  {mockSummaryData.keyPoints.map((point, index) => (
                    <li key={index} className="flex items-start">
                      <ChevronRight className="w-4 h-4 mt-1 mr-2 flex-shrink-0" style={{ color: '#3b82f6' }} />
